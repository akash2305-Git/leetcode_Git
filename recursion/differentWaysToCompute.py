...
class differentWaysToCompute:

    def add_paranthesis_recusrion(self,expression:str) -> List[int]:
        ...
        for i in range(len(expression)):
            ...
            if oper == "+" or oper == "-" or oper == "*":
                ...
                s1 = self.add_paranthesis_recusrion(sub_str1)
                s2 = self.add_paranthesis_recusrion(sub_str2)
...
if __name__ == "__main__":
    ...
    dwc = differentWaysToCompute()
    expression = "2-1-1"
    ans = dwc.add_paranthesis_recusrion(expression)
